	...
	return (
		<section className="flex flex-col gap-6 md:flex-row md:gap-12 w-full px-4 py-8">
			...
			<ul className="flex flex-col gap-2 text-neutral-300">
				<li className="w-full">
					<a className="hover:underline block md:inline-block" href="/">
						Home
					</a>
				</li>
				<li className="w-full">
					<a className="hover:underline  block md:inline-block" href="/about">
						About
					</a>
				</li>
				<li className="w-full">
					<a className="hover:underline block md:inline-block" href="/terms">
						Terms and Conditions
					</a>
				</li>
				<li className="w-full">
					<a className="hover:underline block md:inline-block" href="/shipping">
						Shipping and Return Policy
					</a>
				</li>
				<li className="w-full">
					<a className="hover:underline block md:inline-block" href="/privacy">
						Privacy Policy
					</a>
				</li>
				<li className="w-full">
					<a className="hover:underline block md:inline-block" href="/FAQ">
						FAQ
					</a>
				</li>
			</ul>
